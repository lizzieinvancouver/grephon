...
\begin{enumerate}
\item Unexpected controversy over GSL\footnote{GSL: growing season length;  RL: resource limitation} and tree growth \todo{needs organizing}
\begin{enumerate}
\item Basics: GDD model of growth suggests GSL x growth (with some base temperature for GDD)
\item But ... Tree ring old studies do show GSL x growth (ring width) \todo{Do they? Need refs} ... this might be inferred through tree line or such.
