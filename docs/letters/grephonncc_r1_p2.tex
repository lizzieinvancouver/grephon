...
\end{enumerate}
Additionally, we have added discussion of primary versus secondary growth (e.g. \lr{R1growth} and \lr{R1box0}, \lr{R1box1}, \lr{R1box2}) and we return to this in our section `Building a new framework for growth × season length relationships,' and we have added a clear discussion of importance of understanding growth rate. These changes, as well as many others to address reviewer concerns and improve the manuscript, are outlined in detail below.\\
