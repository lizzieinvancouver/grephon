...
{\bf Response to editor's comments:}  % See dothisGREPHON for notes on figures and overhaul of Section 3. 

We appreciate the chance to revise this work. While we were excited to see that most reviewers felt this was an important topic with potential, we were motivated by concerns of some reviewers that our ideas were not clear enough to highlight their novelty and utility to push the field forward. To address this we have:
\begin{enumerate}
\item Completely overhauled the third section (`Building a new framework for growth × season length relationships') to be focused on the most critical questions to answer with clear suggestions of how to do it, \lr{startframework}-\lr{R3complaint1E}
\item Designed and integrated into the text several new figures (Fig. \ref{fig:moraconcept}, Fig. \ref{fig:phylomodel}) and a new figure in the Box (Growth, growing season length and the challenge of standardized metrics).
\item Streamlined the earlier text to make space for a longer discussion and explanation of our suggested framework. 
\end{enumerate}
Additionally, we have added discussion of primary versus secondary growth (e.g. \lr{R1growth} and \lr{R1box0}, \lr{R1box1}, \lr{R1box2}) and we return to this in our section `Building a new framework for growth × season length relationships.' We have also added a clear discussion of importance of understanding growth rate, with related new figures. These changes, as well as many others to address reviewer concerns and improve the manuscript, are outlined in detail below.\\
...
We very much agree. As mentioned above we overhauled the last sections (effectively, the second half) of the manuscript to address this. We now emphasize part of the reviewer's latter point as a critical question to address in `How do external drivers and internal constraints act together?' from \lr{R3complaint1S} to \lr{R3complaint1E}. We do group papers by the individual hypotheses they test, but did not mean to indicate that these hypotheses are mutually exclusive and have updated the caption of Fig. \ref{fig:hypotheses} to clearly state this. We agree with the reviewer that the reality is far more complicated than any individual hypothesis here can express, and have added a clarifying statement in the text as well at \lr{R2complaint1nonmutexcl}. In revising our manuscript, we have increased the emphasis on what we need to know and future directions for research and modeling. We hope that by focusing more on how much we still need to resolve to understand how climatic factors shape growth, we will encourage more mechanism-centered experimental design and model development.\\
...
We completely agree and this was an important concern also raised by Reviewer 1. As we mentioned in response to Reviewer 1, we struggled with how much to address this in our initial submission, confining discussion of this complexity to the supplement, but we agree it needs a more direct discussion in the main text. To address this we have updated our Box (now entitled `Growth, growing season length and the challenge of standardized metrics') to discuss the complexity of growth and growing season length and added a new figure to the Box. We now cite this Box  on \lr{R1box0}, \lr{R1box1}, \lr{R1box2} and we also directly discuss this issue on \lr{R1growth}. \\
