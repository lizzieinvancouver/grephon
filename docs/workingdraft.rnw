...
Recently a growing number of studies have challenged a fundamental assumption of most forecasts of future climate climate: that longer growing seasons lead to increased tree growth. This has generated alarm---as increased growth is expected to offset carbon emissions---and a number of hypotheses for why longer growing seasons may not always increase tree growth, including drought-related constraints, internal limits, and methodological differences. Here, using a review of recent literature across spatial scales and methods, we find the  perception that longer seasons do not lead to increased growth was supported by only  \Sexpr{percenoevi}\% of studies, while most---\Sexpr{perceanyevi}\% of studies---supported the assumption that that longer growing seasons lead to increased growth, with persistent variation across methods, species and years of study. The resulting challenge is thus to understand and predict this widespread variation. We found proposed hypotheses were rarely well-tested, especially across methods. Studies of tree ring growth tended to focus on external drivers, such as drought, while physiological studies of biomass or carbon allocation, tended to focus on internal limits, such as effects of photoperiod. We argue that bridging this disciplinary divide and integrating theory from evolutionary biology, community ecology and life history could rapidly help develop and test a mechanistic framework for when longer seasons will---or will not---lead to greater growth. 
\end{abstract}
