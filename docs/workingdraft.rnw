...
\newpage
\section{Figures}
% 30 May 2024: Ruben updated all figures to make them look better. I have kept the new paths and left the old paths below so we have them. 
...
\begin{figure}[h!]
\includegraphics[width=0.8\textwidth]{..//figures/_allfiguresFromRuben/growthbyelevation.png}   % {..//analyses/growthxelevationetc/figures/growthbyelevation_plot.pdf}
...
\clearpage
\begin{figure}[h!]
\includegraphics[width=1\textwidth]{..//figures/_allfiguresFromRuben/heatmap.png} % {..//figures/heatmaps/combinedheatmap_gslxgrowth_simple.pdf}
...
\clearpage
\begin{figure}[h!]
\includegraphics[width=0.5\textwidth]{..//figures/_allfiguresFromRuben/Tempresponses.png} %{..//figures/tempresponse/drafttempfig.png}
...
\clearpage
\begin{figure}[h!]
\includegraphics[width=1\textwidth]{..//figures/_allfiguresFromRuben/itrdb_vs_pep.png} %{..//figures/itrdbpep.png}
