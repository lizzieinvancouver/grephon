...
######################################
hypd <- read.csv("output/hyp_mergeable.csv")
hypd$paper_id <- tolower(gsub(" ", "", hypd$addressed.in.which.Grephon.paper))
...
hypd <- hypd[-which(hypd$paper_id=="bruening2017"),]
...
hypd$paper_id[hypd$paper_id=="vitasseetal.2009"] <- "vitasseetal.2009"
hypd$paper_id[hypd$paper_id=="zohneretal2023"] <- "zohner2023"


# Do not show up in hypotheses table ... eckes-shephard2020
# Do not show up in d (grephon): zuetal2021
