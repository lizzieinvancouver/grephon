...
\end{enumerate}
\item Week 5:  Soolananayakanahally \emph{et al.} 2013
\iffalse
LS - leaf senescence 

Summarise: BB is sensitive to warming as we know, but HGC also responds in opposite direction (earlier with earlier springs) -- they have bud flush versus bud-set and leaf senenscence... HGC variation was higher in Vancouver (and lots of variation)
...
HGC happens before LS.

HGC -- their evidence that it reversed?
...
They mention that length of night is what matters (so maybe wavelength during the day doesn't matter so much).
